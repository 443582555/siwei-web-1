 ...
 * Generated at: 2019-03-18 18:59:38 UTC
...
public final class chezhan_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <label>车站名称：</label><input id=\"key-station_name\" class=\"easyui-textbox\">\r\n");
      ...
      out.write("        \tif(!$(\"#chezhan-form\").form('enableValidation').form('validate')){\r\n");
      out.write("        \t\t$.messager.alert('信息提示',\"您有必填项目未填写，请填写完整！\",'info');\r\n");
      out.write("        \t\treturn false;\r\n");
      out.write("        \t}\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                url:'line/addStation.do',\r\n");
      out.write("                data: $('#chezhan-form').serialize(),\r\n");
      ...
      out.write("            $.ajax({\r\n");
      out.write("            \ttype: 'POST',\r\n");
      out.write("                url:'line/updateStation.do',\r\n");
      out.write("                data: $('#chezhan-form').serialize(),\r\n");
      out.write("                dataType: \"json\",\r\n");
      out.write("                success:function(data){\r\n");
      out.write("                    var returnMsg = data.returnMsg?data.returnMsg:\"提交失败\";\r\n");
      ...
      out.write("                    $.ajax({\r\n");
      out.write("                    \ttype: 'POST',\r\n");
      out.write("                        url:'line/deleteStation.do',\r\n");
      out.write("                        data:{\r\n");
      ...
      out.write("                href: \"train/lineDialog.do?rwb_railwaybigtype=2\",\r\n");
      ...
      out.write("                \t$('#chezhan-form').form('load', item);\r\n");
      out.write("                },\r\n");
      out.write("                buttons: [{\r\n");
      out.write("                    text: '确定',\r\n");
      out.write("                    iconCls: 'icon-ok',\r\n");
      ...
      out.write("            \tname: $(\"#key-station_name\").val()\r\n");
      out.write("            };\r\n");
      out.write("            $('#dg').datagrid(\"reload\");\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function reset(){\r\n");
      out.write("        \t$(\"#key-station_name\").textbox(\"setValue\",\"\");\r\n");
      out.write("        \t$('#dg').datagrid('options').queryParams = {};\r\n");
      out.write("            $('#dg').datagrid(\"reload\");\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      ...
      out.write("            url:'line/queryStation.do',\r\n");
      ...
      out.write("\t\t        { field:'name',title:'车站名称',width:150,align:'center'},\r\n");
      out.write("                { field:'rwb_stationno',title:'车站编码',width:120,align:'center'}\r\n");
      out.write("\t\t    ]],\r\n");
      out.write("            columns:[[\r\n");
      out.write("                { field:'station_property',title:'车站属性',width:120,align:'center'},\r\n");
      out.write("                { field:'rwb_railwaykind_name',title:'车站附属正线',width:120,align:'center'},\r\n");
      out.write("                { field:'rwb_lenth',title:'车站中心里程',width:120,align:'center'},\r\n");
      out.write("                { field:'stock_number',title:'股道数',width:120,align:'center'}\r\n");
      out.write("            ]],\r\n");
      out.write("            toolbar: [{\r\n");
      out.write("\t            text: '添加', \r\n");
