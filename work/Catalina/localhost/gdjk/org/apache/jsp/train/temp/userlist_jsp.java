 ...
 * Generated at: 2019-03-07 22:08:30 UTC
...
public final class userlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t            <label>姓名：</label><input id=\"key-username\" class=\"easyui-textbox\">\r\n");
      out.write("\t            <label>账号：</label><input id=\"key-loginname\" class=\"easyui-textbox\">\r\n");
      out.write("\t            <input type=\"hidden\" id=\"key-dept\">\r\n");
      ...
      out.write("        \tif(!$(\"#user-form\").form('enableValidation').form('validate')){\r\n");
      out.write("        \t\t$.messager.alert('信息提示',\"您有必填项目未填写，请填写完整！\",'info');\r\n");
      out.write("        \t\treturn false;\r\n");
      out.write("        \t}\r\n");
      out.write("        \t$.ajax({\r\n");
      out.write("        \t\ttype: 'POST',\r\n");
      out.write("                url:'sys/addUser.do',\r\n");
      out.write("                data: $('#user-form').serialize(),\r\n");
      ...
      out.write("       \t\t$.ajax({\r\n");
      out.write("       \t\t\ttype: 'POST',\r\n");
      out.write("                url:'sys/updateUser.do',\r\n");
      out.write("                data: $('#user-form').serialize(),\r\n");
      out.write("                dataType: \"json\",\r\n");
      out.write("                success:function(data){\r\n");
      out.write("\t\t\t        var returnMsg = data.returnMsg?data.returnMsg:\"提交失败\";\r\n");
      ...
      out.write("                    $.ajax({\r\n");
      out.write("                    \ttype: 'POST',\r\n");
      out.write("                        url:'sys/deleteUser.do',\r\n");
      out.write("                        data:{\r\n");
      out.write("                            tu_id:item.tu_id\r\n");
      out.write("                        },\r\n");
      out.write("                        dataType: \"json\",\r\n");
      out.write("                        success:function(data){\r\n");
      out.write("\t\t\t\t\t\t\tvar returnMsg = data.returnMsg?data.returnMsg:\"提交失败\";\r\n");
      ...
      out.write("                href: \"train/userlist-dialog.do\",\r\n");
      ...
      out.write("                \t$('#user-form').form('load', item);\r\n");
      out.write("                },\r\n");
      out.write("                buttons: [{\r\n");
      out.write("                    text: '确定',\r\n");
      out.write("                    iconCls: 'icon-ok',\r\n");
      ...
      out.write("            \tdepart_id: $('#tt').tree(\"getSelected\")?$('#tt').tree(\"getSelected\").id:\"\",        //部门\r\n");
      out.write("                username: $(\"#key-username\").val(),     //用户名\r\n");
      out.write("                login_name: $(\"#key-loginname\").val()   //登录名\r\n");
      out.write("            };\r\n");
      out.write("            $('#dg').datagrid(\"reload\");            \r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function reset(){\r\n");
      out.write("        \t$(\"#tt\").find('.tree-node-selected').removeClass('tree-node-selected');\r\n");
      out.write("            $(\"#key-username\").val(\"\");\r\n");
      out.write("            $(\"#key-loginname\").val(\"\");\r\n");
      out.write("        \t$('#dg').datagrid('options').queryParams = {};\r\n");
      out.write("            $('#dg').datagrid(\"reload\");            \r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      ...
      out.write("                { field:'username',title:'姓名',width:'100',align:'center'},\r\n");
      out.write("                { field:'login_name',title:'帐号',width:'100',align:'center'}\r\n");
      out.write("\t\t    ]],\r\n");
      out.write("            columns:[[\r\n");
      out.write("                { field:'tr_name',title:'角色',width:'100',align:'center'},\r\n");
      out.write("                { field:'depart_name',title:'单位',width:'230',align:'center'},\r\n");
      out.write("                { field:'mobile',title:'电话',width:'150',align:'center'},\r\n");
      out.write("                { field:'email',title:'邮箱',width:'200',align:'center'},\r\n");
      out.write("                { field:'gen_time',title:'创建时间',width:'170',align:'center'},\r\n");
      out.write("                { field:'login_time',title:'登录时间',width:'170',align:'center'},\r\n");
      out.write("                { field:'last_login_time',title:'上次登录时间',width:'170',align:'center'},\r\n");
      out.write("                { field:'count',title:'登录次数',width:'100',align:'center'}\r\n");
      out.write("            ]],\r\n");
      out.write("            toolbar: [{ \r\n");
      out.write("\t            text: '添加', \r\n");
