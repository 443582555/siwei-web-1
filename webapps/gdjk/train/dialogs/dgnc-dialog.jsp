...
<body>
        <form id="dgnc-form" method="post">
            <table style="width:100%">
                <tr>
                    <td width="100" align="right">设备名称:</td>
                    <td><input class="easyui-textbox" type="text" name="name" id="name" required="required" style="width:200px"></td>
                ...
                <tr>
                    ...
                    <td><input class="easyui-datebox" type="text" name="production_date" id="production_date" data-options="sharedcalendar:'#cc'" required="required" style="width:200px"></td>
