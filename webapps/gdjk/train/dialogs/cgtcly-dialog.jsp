...
<body>
	<form id="cgtcly-form" method="post">
		<table style="width:100%">
			...
			<tr>
				...
				<td><input class="easyui-datebox" type="text" name="production_date" id="production_date" data-options="editable:false,required:true" style="width:200px"></td>
