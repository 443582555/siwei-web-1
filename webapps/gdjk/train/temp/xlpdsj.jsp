    ...
    <script type="text/javascript">
        ...
        */
        $('#dg').datagrid({
            ...
            columns:[[
                { title:'变坡点里程',colspan:2,align:'center'},
                { field:'dsy',title:'坡长',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'坡度值(‰)',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'变坡点标高',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'竖曲线半径',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'竖曲线长',rowspan:2,width:100,align:'center'},
                { title:'竖曲线范围',colspan:2,align:'center'},
                { field:'dsy',title:'备注',rowspan:2,width:100,align:'center'}
            ],[
                { field:'dsy',title:'现场里程',width:100,align:'center'},
                { field:'dsy',title:'贯通里程',width:100,align:'center'},
                { field:'dsy',title:'起里程',width:100,align:'center'},
                { field:'dsy',title:'终里程',width:100,align:'center'}
            ]],
            toolbar: [{ 
	            text: '导入', 
	            iconCls: 'icon-add', 
