    ...
    <script type="text/javascript">
        ...
        */
        $('#dg').datagrid({
            ...
            striped: true,
            frozenColumns:[[
		        { field:'',width:100,rowspan:2,align:'center',checkbox:true},
		        { field:'swinstrumentid',title:'带号',rowspan:2,width:120,align:'center'}
		    ],[]],
            columns:[[
                { title:'交点坐标',colspan:2,align:'center'},
                { field:'dsy',title:'ZH(ZY)里程',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'HZ(YZ)里程',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'偏角值',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'转向',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'半径',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'起切长',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'终切长',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'曲线长',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'起缓',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'终缓',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'外矢距',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'超高',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'直顺超高起',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'直顺超高终',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'备注',rowspan:2,width:100,align:'center'}
            ],[
                { field:'type_name',title:'交点坐标X',width:150,align:'center'},
                { field:'type_name',title:'交点坐标Y',width:150,align:'center'}
            ]],
            toolbar: [{ 
	            text: '导入', 
	            iconCls: 'icon-add', 
