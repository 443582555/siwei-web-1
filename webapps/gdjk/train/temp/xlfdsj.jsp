    ...
    <script type="text/javascript">
        ...
        */
        $('#dg').datagrid({
            ...
            columns:[[
                { field:'dsy',title:'分带段号',width:100,align:'center'},
                { field:'dsy',title:'数学基础代号',width:100,align:'center'},
                { field:'dsy',title:'起点里程',width:100,align:'center'},
                { field:'dsy',title:'终点里程',width:100,align:'center'},
                { field:'dsy',title:'分段标示起里程',width:150,align:'center'},
                { field:'dsy',title:'分段标示终里程',width:150,align:'center'},
                { field:'dsy',title:'备注',width:100,align:'center'}
            ]],
            toolbar: [{ 
	            text: '导入', 
	            iconCls: 'icon-add', 
