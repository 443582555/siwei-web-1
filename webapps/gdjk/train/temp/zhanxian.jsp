...
<%@ page contentType="text/html; charset=UTF-8"%>
    ...
    <script type="text/javascript">
        ...
        */
        function add(){
        	if(!$("#zhanxian-form").form('enableValidation').form('validate')){
        		$.messager.alert('信息提示',"您有必填项目未填写，请填写完整！",'info');
        		return false;
        	}
            $.ajax({
                url:'line/addLine.do',
                data: $('#zhanxian-form').serialize(),
                dataType: "json",
        ...
        */
        function openAdd(){
            $('<div id="dialog"></div>').dialog({
                ...
                modal:true,
                closed: false,
                href: "train/lineDialog.do?rwb_railwaybigtype=3",
                onClose:function(){  
                    $(this).dialog('destroy');  
                },
                buttons: [{
        ...
        */
        $('#dg').datagrid({
            ...
            columns:[[
                ...
                { field:'rwb_railstationno',title:'所属车站名称',width:150,align:'center'},
