...
<body>
    ...
    <script type="text/javascript">
        ...
        */
        function add(){
        	if(!$("#zlmx-form").form('enableValidation').form('validate')){
        		$.messager.alert('信息提示',"您有必填项目未填写，请填写完整！",'info');
        		return false;
        	}
            $.ajax({
            	type: 'POST',
                url:'lj/insertZlmx.do',
                data: $('#zlmx-form').serialize(),
                dataType: "json",
        ...
        */
        $('#dg').datagrid({
            ...
            columns:[[                
            	{field:'sbslh',title:'设备序列号',width:100,align:'center'},
            	{field:'zlbh',title:'所属租赁编号',width:100,align:'center'},
            	{field:'zldw_name',title:'租赁单位名称',width:100,align:'center'},
