        ...
        */
        $('#dg').datagrid({
            ...
            frozenColumns:[[
		        ...
		        { field:'dsy',title:'带号',rowspan:2,width:100,align:'center'}
		    ],[]],
            columns:[[
                { field:'dsy',title:'点编号',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'原编号',rowspan:2,width:100,align:'center'},
                { title:'CPⅢ棱镜中心坐标',colspan:2,align:'center'},
                { field:'dsy',title:'现场里程',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'贯通里程',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'横偏距',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'点方位',rowspan:2,width:100,align:'center'},
                { field:'dsy',title:'备注',rowspan:2,width:100,align:'center'}
            ],[
                { field:'dsy',title:'X(m)',width:100,align:'center'},
                { field:'dsy',title:'Y(m)',width:100,align:'center'},
                { field:'dsy',title:'Z(m)',width:100,align:'center'}
            ]],
            toolbar: [{ 
	            text: '导入', 
	            iconCls: 'icon-add', 
